...
from world.apps.comments.forms import Comment, CommentForm
from world.apps.core.mixins import AuthorRequiredMixin, LoginRequiredMixin
...
class ArticleListView(ListView):
    ...
    template_name = "world/articles/article_list.html"
...
class ArticleDetailView(DetailView):
    ...
    template_name = "world/articles/article_detail.html"
...
class ArticleCreateView(AuthorRequiredMixin, CreateView):
    ...
    template_name = "world/articles/article_form.html"
